...
## 📊 Live Dashboards
- 🔴 **Tableau Public (Live):** [Click here to view](YOUR_TABLEAU_LINK_HERE)
- 📁 **Power BI Dashboard:** Available in `/dashboards` folder

## 📈 Visualizations
### Chart 1 — Treatment Rate by Occupation
![Chart 1](visualizations/chart1_occupation_treatment.png)

### Chart 2 — Risk Factors Analysis
![Chart 2](visualizations/chart2_risk_factors.png)

### Chart 3 — Gender, Coping & Social Analysis
![Chart 3](visualizations/chart3_gender_coping_social.png)
